...
public class CredentialsController {
    ...
    public ResponseResult<List<Credential>> listCredentials(@RequestHeader("Authorization") String token) {
        try {
            return ResponseResult.success(credentialsService.listCredentials(token.substring(7)));
        } catch (Exception e) {
